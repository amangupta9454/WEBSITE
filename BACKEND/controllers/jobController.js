...
exports.getUserStatus = async (req, res) => {
  try {
    ...
    res.status(200).json({
      ...
      freeModeExpires,
      premiumPrice,
      expiresAt: isFreeMode ? (freeModeExpires ? new Date(freeModeExpires).toLocaleDateString('en-GB', { day: '2-digit', month: '2-digit', year: 'numeric' }) : 'Active Promo') : (user.jobPortalPremiumExpires || null),
