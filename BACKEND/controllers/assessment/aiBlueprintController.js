...
const SYSTEM_TEMPLATES = [
  {
    ...
    provider: "Groq",
    providerModel: "llama-3.3-70b-specdec",
...
exports.createBlueprint = async (req, res) => {
  try {
    ...
    const newBlueprint = new AssessmentAIBlueprint({
      ...
      providerModel: providerModel || "llama-3.3-70b-specdec",
      status: status || "Active",
      tags: tags || ["Custom", "AI"],
...
exports.importBlueprint = async (req, res) => {
  try {
    ...
    const importedDoc = new AssessmentAIBlueprint({
      ...
      providerModel: payload.providerModel || "llama-3.3-70b-specdec",
...
exports.testBlueprint = async (req, res) => {
  try {
    ...
    const model = "llama-3.3-70b-specdec"; // Runtime Managed target
