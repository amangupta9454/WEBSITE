...
const registerInternship = async (req, res) => {
  try {
    ...
    const mailOptions = {
      ...
      html: `<div style="font-family:Arial,Helvetica,sans-serif;max-width:650px;margin:auto;background:#ffffff;color:#333333;">

  <!-- Banner -->

  <div style="padding:15px;">

<h2 style="margin:0 0 15px 0;color:#2563eb;">
...
<p style="font-size:15px;line-height:1.6;margin:0 0 12px 0;">
  Thank you for applying for the <strong>${domain}</strong> Internship Program at <strong>CODE-A-NOVA</strong>.
</p>
...
<p style="font-size:15px;line-height:1.6;margin:0;">
  If you are shortlisted, further communication regarding the next steps will be sent to your registered email address.
</p>
