 ...
 */
function buildInterviewContextObject(candidate = {}, liveState = {}) {
...
const { resolveEnterpriseMode } = require('./enterpriseModeResolver');
 ...
 */
function buildSystemPrompt(ctx, interviewerName = 'standard', mode = 'standard') {
 ...
 */
function buildInterviewContext({ mode = 'standard', interviewerName = 'standard', candidate = {}, liveState = {} }) {
 ...
 */
function buildRouterContextSummary(ctx, activeInterviewers = ['Sarah', 'David'], escalation = null) {
  const mem = ctx.recruiterMemory;
  let summary = '';
...
module.exports = { buildInterviewContextObject, buildSystemPrompt, buildInterviewContext, buildRouterContextSummary, INTERVIEWER_PERSONAS, COMPANY_INTERVIEW_MODES };
