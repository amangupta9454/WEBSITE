      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 sm:p-10 border border-slate-200">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-500 mt-2 text-sm font-medium">Access your internship dashboard</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="group">
              ...
              <p className="text-xs text-slate-500 mt-2">Default is Welcome@123</p>
            </div>
