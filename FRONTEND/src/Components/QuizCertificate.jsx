          ...
          <div style={{ 
            ...
            <div style={{ textAlign: 'center', width: '200px' }}>
              <div style={{ height: '60px', display: 'flex', alignItems: 'flex-end', justifyContent: 'center', marginBottom: '4px' }}>
                 <img src={founderSign} alt="Himanshu Gupta Signature" style={{ maxHeight: '100%', maxWidth: '100%', objectFit: 'contain', transform: 'scale(2.5)', transformOrigin: 'bottom' }} crossOrigin="anonymous" />
              </div>
