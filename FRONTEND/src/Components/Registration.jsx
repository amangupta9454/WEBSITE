...
import 'react-toastify/dist/ReactToastify.css';
import emailjs from '@emailjs/browser';
import { Loader2, Send, User, GraduationCap, Briefcase, Link2, MessageSquare, CheckCircle2 } from 'lucide-react';
...
const Registration = () => {
  ...
  const domains = ['Frontend Development', 'Backend Development', 'MERN Stack Development', 'C Programming', 'Python Development', 'AI', 'Figma or UI/UX', 'Data Science', 'Machine Learning','Full Stack Development'];
  const durations = ['1 Month', '2 Months', '3 Months'];
  const hearOptions = ['LinkedIn', 'College', 'Friends/Students', 'Instagram', 'Website'];
