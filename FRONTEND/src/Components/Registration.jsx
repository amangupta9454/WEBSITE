...
// new one
import { ExternalLink, Send, FileText, User, GraduationCap, Briefcase } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex items-center justify-center px-4 py-12 sm:py-16">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-blue-600 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse animation-delay-2000"></div>
      </div>
      ...
      <div className="relative max-w-4xl w-full">
        ...
        <div className="bg-slate-900/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-800 overflow-hidden">
          <div className="p-8 sm:p-12 lg:p-16 text-center">
            ...
            {/* Description */}
            <p className="text-gray-300 text-base sm:text-lg lg:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
              Take the next step in your career. Fill out our application form to apply for an exciting internship opportunity.
            </p>
            ...
            <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-8 text-gray-400">
              <div className="flex flex-col items-center">
                ...
                <span className="text-sm sm:text-base font-medium">Personal Details</span>
              </div>
              <div className="flex flex-col items-center">
                <div className="p-4 bg-gray-800 rounded-2xl mb-4">
                  <GraduationCap className="w-10 h-10 text-blue-400" />
                </div>
                <span className="text-sm sm:text-base font-medium">Academic Info</span>
              </div>
              <div className="flex flex-col items-center">
                <div className="p-4 bg-gray-800 rounded-2xl mb-4">
                  <Briefcase className="w-10 h-10 text-indigo-400" />
                </div>
                <span className="text-sm sm:text-base font-medium">Resume & Preferences</span>
              </div>
            </div>

            {/* Footer Text */}
            <p className="mt-12 text-gray-500 text-sm sm:text-base">
              All applications are carefully reviewed. We’ll reach out via email or WhatsApp if selected.
            </p>
          </div>
        </div>
      </div>
