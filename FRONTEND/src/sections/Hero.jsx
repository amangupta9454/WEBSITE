      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 w-full">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div 
            ...
            className="text-left"
          >
            <motion.div variants={fadeUp} className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-gray-200 shadow-sm mb-8">
              <span className="flex h-2 w-2 rounded-full bg-green-500 animate-pulse"></span>
              <span className="text-sm text-gray-600 font-bold tracking-wide uppercase">Premium Business Solutions</span>
            </motion.div>
            
            <motion.h1 variants={fadeUp} className="text-5xl md:text-7xl lg:text-[5rem] font-black leading-[1.05] mb-6 tracking-tight text-gray-900">
              Build a <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Website</span> That <br className="hidden md:block"/>
              Grows Your Business.
            </motion.h1>
            
            <motion.p variants={fadeUp} className="text-lg md:text-xl text-gray-500 mb-10 max-w-xl leading-relaxed font-medium">
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4">
              <button className="px-8 py-4 bg-gray-900 text-white rounded-full font-bold flex items-center justify-center gap-2 hover:bg-gray-800 transition-all shadow-xl shadow-gray-900/20 hover:-translate-y-0.5">
                Build My Website <ArrowRight size={18} />
              </button>
              <button className="px-8 py-4 bg-white text-gray-900 border border-gray-200 rounded-full font-bold flex items-center justify-center gap-2 hover:bg-gray-50 transition-all shadow-sm hover:shadow-md">
                View Our Work
              </button>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <motion.div 
              ...
              className="absolute top-10 right-0 w-[480px] bg-white/90 border border-gray-100 rounded-3xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] overflow-hidden backdrop-blur-2xl"
            >
              <div className="h-12 border-b border-gray-100 flex items-center px-6 gap-2 bg-gray-50/80">
                <div className="w-3 h-3 rounded-full bg-red-400" />
                <div className="w-3 h-3 rounded-full bg-yellow-400" />
                <div className="w-3 h-3 rounded-full bg-green-400" />
                <div className="ml-4 text-xs text-gray-400 font-bold flex-1 text-center pr-12 tracking-wider">RESTAURANT_ORDERS_DASHBOARD</div>
              </div>
              <div className="p-8">
                <div className="flex justify-between items-end mb-8">
                  <div>
                    <p className="text-gray-400 text-sm font-bold mb-1 uppercase tracking-wider">Online Sales</p>
                ...
                <div className="flex gap-4">
                  <div className="flex-1 bg-gray-50 p-5 rounded-2xl border border-gray-100 hover:border-purple-200 transition-colors group">
                    <Layout className="text-purple-600 mb-3 group-hover:scale-110 transition-transform" size={24} />
            ...
            >
              ...
              <div>
                <p className="text-sm font-bold text-gray-900">Gym Website Live</p>
                <p className="text-xs font-medium text-green-500">50+ New Members</p>
              </div>
            </motion.div>
          </motion.div>
