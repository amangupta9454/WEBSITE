    ...
    <section className="py-12 md:py-24 relative overflow-hidden bg-white">
      <div className="max-w-5xl mx-auto px-4 md:px-12 relative z-10">
        <motion.div 
          ...
          variants={fadeUp}
          className="relative bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 rounded-[2rem] md:rounded-[3rem] p-8 md:p-20 text-center shadow-2xl shadow-blue-900/20 overflow-hidden border border-blue-400/30"
        >
          ...
          <div className="relative z-10">
            <h2 className="text-3xl md:text-6xl font-black mb-4 md:mb-6 text-white leading-tight tracking-tight">
